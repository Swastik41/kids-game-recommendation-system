    ...
    <main className="home">
      ...
      <section className="hero">
        <div className="container">
          <h1>
            Kids Game <br /> Exploration System
          </h1>
        ...
        <div className="container">
          ...
          <div className="steps">
            ...
            <div className="step">
              ...
              <p>
                Filter by categories like puzzles, coding, creativity, strategy,
                or quick mini-games for short breaks.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="grid grid--3">
            <div className="card feature">
              <h3>Safety first</h3>
              <p>
                Games are checked for age-appropriateness, content, and the type of
      ...
      <section className="section">
        <div className="container">
          <header className="section__header">
            ...
            <p style={{ color: "#000000" }}>
              Short feedback from the perspectives that matter.
            </p>
          </header>
          ...
          <div className="grid grid--3 testimonials">
            <figure className="testimonial">
              <blockquote>
                “It saves me so much time. Instead of searching the app store,
                I open PixiPlay, pick a category, and we’re ready to go.”
              </blockquote>
            ...
            <figure className="testimonial">
              <blockquote>
                ...
                who finish early. They think it’s fun — I know it’s practice.”
              </blockquote>
      ...
      <section className="section cta">
        <div className="container cta__content">
          <div>
            ...
            <p>
              Start using PixiPlay as your “first stop” before any new game.
              It takes less than a minute to find a better option.
            </p>
          </div>
